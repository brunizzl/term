...
/*	TODO:
		INVERSE OPERANDEN AUS SUMME + PRODUKT ENTFERNEN
		SUMME UND PRODUKT ZUSAMMENLEGEN
		PATTERNZEUG IN EIGENE DATEI VERSCHIEBEN
		comp_to_pattern() FÜR VARIADIC-PATTERN-OPERATOR SCHREIBEN (REKURSIV?)
*/
